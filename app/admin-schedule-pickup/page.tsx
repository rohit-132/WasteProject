...
export default function AdminSchedulePickupPage() {
  ...
  // Fetch users for admin to select from
  useEffect(() => {
    if (isAdmin && !isCheckingRole) {
      ...
      setUsers([
        ...
        { id: "user_789", name: "Sam Johnson" },
        { id: "user_234", name: "Maria Garcia" },
        { id: "user_567", name: "Alex Lee" },
      ]);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAdmin) {
      setError("Only administrators can schedule pickups on behalf of users.");
      return;
    }
  ...
  // Admin view with pickup form
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="flex items-center mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-slate-800">
          Admin: Schedule Pickup for User
        </h1>
      </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              You are scheduling a pickup on behalf of a user. This is an
              admin-only function.
            </p>
          </div>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-green-700">
                  Pickup has been successfully scheduled for the user!
                  Redirecting...
                </p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    required
                    className="pl-10 block w-full rounded-md border-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  >
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Select the user for whom you are scheduling this pickup
                </p>
              </div>

              {/* Initial Status - Admin Only Field */}
              <div>
                <label
                  htmlFor="status"
                  className="block text-sm font-medium text-slate-700 mb-1"
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="block w-full rounded-md border-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                >
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Set the initial status for this pickup
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Describe the type of waste to be picked up
                </p>
              </div>
